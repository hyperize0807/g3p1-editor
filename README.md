...
> ### ▶ 바로 사용하기 (설치 불필요)
> **<https://hyperize0807.github.io/g3p1-editor/>**
> PC·모바일 모두 위 주소를 브라우저로 열면 바로 사용할 수 있습니다. (📱 휴대폰에서 아이템 사전·직업 사전을 보거나 세이브를 편집할 때 가장 간편합니다.)
...
### 모바일 (웹에서 바로 열기)
- **<https://hyperize0807.github.io/g3p1-editor/>** 를 사파리/크롬으로 엽니다.
- 아이템 사전·직업 사전 열람은 물론, 세이브 편집·저장도 동작합니다.
- ℹ️ iOS '파일' 앱에서 HTML을 직접 탭하면 미리보기(Quick Look)로 열려 **자바스크립트가 제한**되므로 버튼이 동작하지 않습니다. 반드시 위 주소를 **브라우저**로 여세요.
